...
class Product(models.Model):
    ...
    def count_review(self: Self) -> int:
...
class ProductGallery(models.Model):
    product = models.ForeignKey(Product, default=None, on_delete=models.CASCADE)  # type: ignore
